...
class AutoDeploy:
    def __init__(self):
        self.local_theme_path: str = "wp-theme-youtuneai"
        self.sftp_config: dict[str, str] = {
            'host': 'access-5017098454.webspace-host.com',
            'username': 'a132096',
            'password': 'Gabby3000!!!',
            'port': '22',  # Port should be a string for consistency
            'remote_path': '/wp-content/themes/youtuneai/'
        }

    def deploy_all_files(self) -> bool:
        ...
        try:
            ...
            ssh.connect(
                ...
                port=int(self.sftp_config['port'])  # Convert port to int for connect method
            )
            ...
            for file in files_to_deploy:
                ...
                remote_file = self.sftp_config['remote_path'] + file  # Ensure remote_path is a string
