...
function openAdminHub() {
    ...
    const overlay = document.getElementById('adminHubOverlay');
    if (overlay) {
        overlay.classList.add('active');
        const passwordScreen = document.getElementById('adminPasswordScreen');
        const mainInterface = document.getElementById('adminMainInterface');
        const passwordInput = document.getElementById('adminPasswordInput');
        
        if (passwordScreen) passwordScreen.style.display = 'flex';
        if (mainInterface) mainInterface.style.display = 'none';
        if (passwordInput) passwordInput.focus();
        console.log('Admin hub opened');
    } else {
        console.error('Admin hub overlay not found!');
        alert('Admin hub not found! Please refresh the page.');
    }
}
