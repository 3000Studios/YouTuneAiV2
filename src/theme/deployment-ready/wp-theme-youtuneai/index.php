...
// If WordPress functions aren't available, show static content
if (!function_exists('get_header')) {
    // Display static HTML version
    include 'index.html';
    exit;
}
...
<div class="content-wrapper">
    ...
    <section class="hero-section fade-in">
        <div class="hero-content">
            <h1 class="hero-title text-3d">YOUTUNEAI PRO</h1>
            <p class="hero-subtitle text-platinum">Revolutionary AI-Powered Voice Control Website</p>
            
            <div class="cta-buttons hero-buttons">
                <button class="btn cta-btn premium-btn" onclick="openAdminHub()">
                    <i class='bx bx-play-circle'></i>
                    ⚡ ADMIN CENTER
                </button>
                <a href="/streaming/" class="btn cta-btn secondary-btn">
                    <i class='bx bx-game'></i>
                    🎮 Streaming Hub
                </a>
                <a href="/shop/" class="btn cta-btn secondary-btn">
